	...
	D3DXMATRIX baseViewMatrix)
{
	...
	result = m_Font->Initialize(device, "../new_engine/data/fontdata.txt", L"../new_engine/data/font.dds");
	if (!result)
	{
	...
	// Now update the sentence vertex buffer with the new string information.
	result = UpdateSentence(m_sentence3, "Count", 100, 300, 1.0f, 1.0f, 0.0f, deviceContext);
	if (!result)
	{
		return false;
	}
